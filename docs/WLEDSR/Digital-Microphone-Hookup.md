...
See also &rArr; [Sound setting examples for common microphones](https://mm.kno.wled.ge/WLEDSR/First-Time-Setup#sound-settings-getting-started-with-common-microphones)

<br/>

**Microphone type** ([SR-WLED sound settings](https://mm.kno.wled.ge/WLEDSR/Sound-Settings#i2s-digital-input))
