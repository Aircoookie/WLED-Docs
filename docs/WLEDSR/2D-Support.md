...
In order to accommodate 2D effects we have modified how Segment settings are used and added 2D Matrix and panel variables on the [Led Preferences](https://mm.kno.wled.ge/WLEDSR/LED-Preferences) settings.
...
See [Segment start stop charts](https://mm.kno.wled.ge/WLEDSR/2D-Support#2d-segment-start-stop-charts) to easy find matrix start and stop values
