...
[sjm autoprod rgbw2+, rgbw4](https://sjmautoprod.com/RGB-Controllers/rgbwX-Wi-Fi-Controllers.html) | Complete, fully-sealed, analog and digital controllers for vehicular use. rgbw2+ has two analog, RGBW channels plus two/four addressable outputs (requires external 5V source for 5V LEDs). rgbw4 has four RGBW channels. Both support 12V or PWM/analog inputs and have internal PTC "fuses".
