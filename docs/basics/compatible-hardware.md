...
[Wasatch Pixels]([https://](https://wasatchpixels.com/shop/) | Series of boards available in 5v and 12v versions. Boards come in single, quad, 6-channel, and 8-channel configurations, including an advanced 8-channel which features fused power outputs. Can be purchased with or without a pre-flashed WT32-ETH01 board.
