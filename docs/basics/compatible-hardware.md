...
[QuinLED-ESP32](https://quinled.info/quinled-esp32/)| Custom design D1 Mini32 formfactor ESP32 module | Fed up with the bad quality of generic ESP32 modules on the market, designed my own "beefed up" version.<br /><br /> Available in multiple versions:<br /> * QuinLED-ESP32-AB (Antenna Board)<br /> * QuinLED-ESP32-AE (Antenna External)<br /> * QuinLED-ESP32-ABE (Antenna Board + Ethernet)
