...
| Name | Description |
|---|---|
[ABC! WLED Controller / ESP8266](https://shop.myhome-control.de/ABC-WLED-Controller-V31-ESP8266/HW10002) | Commercial controller for 5V LED strips. Based on ESP8266 uC. Two outputs. Ready to use. Additional Relay&Fuse board available. (German shop & shipping only within Germany)
[ABC! WLED Controller / ESP32](https://shop.myhome-control.de/ABC-WLED-Controller-V41-ESP32/HW10003.1) | Commercial controller for 5V LED strips. Based on ESP32 uC. Two outputs. Option for digital microphone / sound reactive. Ready to use. Additional Relay&Fuse board available. (German shop & shipping only within Germany)
...
[WLED.SHOP controller V31 / ESP8266 based](https://wled.shop/produkt/wladis-wled-controller-v31/) | Commercial WLED controller / ESP8266 based.
[WLED.SHOP controller board V41 / ESP32 based](https://wled.shop/produkt/wladis-wled-controller-v40-esp32/) | Commercial WLED controller board / ESP32 based. Ready for sound reactive (interface for digital microphone).
