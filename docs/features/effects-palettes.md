...
| ---: | --- | --- | ---
| 0 | Solid | Solid primary color on all LEDs <br />![](https://github.com/photocromax/WLED-live-visualizations/blob/master/GIF/FX_0.gif) | -
| 1 | Blink | Blinks between primary and secondary color <br />![](https://github.com/photocromax/WLED-live-visualizations/blob/master/GIF/FX_1.gif) | Duty cycle of blinking
| 2 | Breathe | Fades between primary and secondary color <br />![](https://github.com/photocromax/WLED-live-visualizations/blob/master/GIF/FX_2.gif) | -
| 3 | Wipe | Switches between primary and secondary, switching LEDs one by one, start to end <br />![](https://github.com/photocromax/WLED-live-visualizations/blob/master/GIF/FX_3.gif) | Smoothness
| 4 | Wipe Random | Same as Wipe, but uses random colors <br />![](https://github.com/photocromax/WLED-live-visualizations/blob/master/GIF/FX_4.gif) | Smoothness
| 5 | Random Colors | Applies a new random color to all LEDs <br />![](https://github.com/photocromax/WLED-live-visualizations/blob/master/GIF/FX_5.gif) | Duration of fading between colors
| 6 | Sweep | Switches between primary and secondary, switching LEDs one by one, start to end to start <br />![](https://github.com/photocromax/WLED-live-visualizations/blob/master/GIF/FX_6.gif) | Smoothness
| 7 | Dynamic | Sets each LED to a random color <br />![](https://github.com/photocromax/WLED-live-visualizations/blob/master/GIF/FX_7.gif) | 0-127: Set single LED 128-255: Set all LEDs
| 8 | Colorloop | Cycle all LEDs through the rainbow colors <br />![](https://github.com/photocromax/WLED-live-visualizations/blob/master/GIF/FX_8.gif) | 0-127: Pastel colors 128-255: Saturated colors
| 9 | Rainbow | Displays rainbow colors along the whole strip <br />![](https://github.com/photocromax/WLED-live-visualizations/blob/master/GIF/FX_9.gif) | Number of rainbows
| 10 | Scan | A single primary colored light wanders between start and end <br />![](https://github.com/photocromax/WLED-live-visualizations/blob/master/GIF/FX_10.gif) | Scan dot size
| 11 | Dual Scan | Same as Scan but uses two lights starting at both ends <br />![](https://github.com/photocromax/WLED-live-visualizations/blob/master/GIF/FX_11.gif) | scan dot size
| 12 | Fade | Fades smoothly between primary and secondary color <br />![](https://github.com/photocromax/WLED-live-visualizations/blob/master/GIF/FX_12.gif) | -
| 13 | Theater | Pattern of one lit and two unlit LEDs running <br />![](https://github.com/photocromax/WLED-live-visualizations/blob/master/GIF/FX_13.gif) | Gap in lights
| 14 | Theater Rainbow | Same as Theater but uses colors of the rainbow <br />![](https://github.com/photocromax/WLED-live-visualizations/blob/master/GIF/FX_14.gif) | -
| 15 | Running | Sine Waves scrolling <br />![](https://github.com/photocromax/WLED-live-visualizations/blob/master/GIF/FX_15.gif) | Wavelength
| 16 | Saw | Sawtooth Waves scrolling <br />![](https://github.com/photocromax/WLED-live-visualizations/blob/master/GIF/FX_16.gif) | Wavelength
| 17 | Twinkle | Random LEDs light up in the primary color with secondary as background, turns all off <br />![](https://github.com/photocromax/WLED-live-visualizations/blob/master/GIF/FX_17.gif) | Amount of LEDs turning on
| 18 | Dissolve | Fills LEDs with primary in random order, then off again <br />![](https://github.com/photocromax/WLED-live-visualizations/blob/master/GIF/FX_18.gif) | Dissolve rate
| 19 | Dissolve Rnd | Fills LEDs with random colors in random order, then off again <br />![](https://github.com/photocromax/WLED-live-visualizations/blob/master/GIF/FX_19.gif) | Dissolve rate
| 20 | Sparkle | Single random LEDs light up in the primary color for a short time, secondary is background <br />![](https://github.com/photocromax/WLED-live-visualizations/blob/master/GIF/FX_20.gif) | -
| 21 | Sparkle Dark | All LEDs are lit in the primary color, single random LEDs turn off for a short time <br />![](https://github.com/photocromax/WLED-live-visualizations/blob/master/GIF/FX_21.gif) | -
| 22 | Sparkle+ | All LEDs are lit in the primary color, multiple random LEDs turn off for a short time <br />![](https://github.com/photocromax/WLED-live-visualizations/blob/master/GIF/FX_22.gif) | -
| 23 | Strobe | All LEDs are lit in the secondary color, all LEDs flash in a single short burst in primary color <br />![](https://github.com/photocromax/WLED-live-visualizations/blob/master/GIF/FX_23.gif) | -
| 24 | Strobe Rainbow | Same as strobe, cycles through the rainbow <br />![](https://github.com/photocromax/WLED-live-visualizations/blob/master/GIF/FX_24.gif) | -
| 25 | Strobe Mega | All LEDs are lit in the secondary color, all LEDs flash in several short bursts in primary color <br />![](https://github.com/photocromax/WLED-live-visualizations/blob/master/GIF/FX_25.gif) | -
| 26 | Blink Rainbow | Same as blink, cycles through the rainbow <br />![](https://github.com/photocromax/WLED-live-visualizations/blob/master/GIF/FX_26.gif) | Blink Duty cycle
| 27 | Android | Section of varying length running <br />![](https://github.com/photocromax/WLED-live-visualizations/blob/master/GIF/FX_27.gif) | Maximum section length
| 28 | Chase | 2 LEDs in primary color running on secondary <br />![](https://github.com/photocromax/WLED-live-visualizations/blob/master/GIF/FX_28.gif) | Size of chaser
| 29 | Chase Random | Like Chase but leaves trail of random color <br />![](https://github.com/photocromax/WLED-live-visualizations/blob/master/GIF/FX_29.gif) | Size of chaser
| 30 | Chase Rainbow | Like 28 but leaves trail of rainbow <br />![](https://github.com/photocromax/WLED-live-visualizations/blob/master/GIF/FX_30.gif) | Size of chaser
